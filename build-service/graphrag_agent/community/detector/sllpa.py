...
class SLLPADetector(GraphProjectionMixin, BaseCommunityDetector):
    ...
    def detect_communities(self) -> Dict[str, Any]:
        """Run SLLPA algorithm community detection (requires GDS)."""
        if not self.G:
        ...
        try:
            ...
            print(f"SLLPA complete: {community_count} communities, {iterations} iterations")
    ...
    def _save_communities_fallback(self) -> Dict[str, int]:
        ...
        try:
            ...
            return {'saved_communities': count, 'note': 'Used simplified save method'}
        except Exception as e:
